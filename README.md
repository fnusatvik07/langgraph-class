...
## The article agent graph

The compiled LangGraph topology (generated by `make_diagram.py`):

<p align="center">
  <img src="graph.png" alt="article agent graph" width="220"/>
</p>

## State flow through every node

A richer teaching view showing exactly which State fields each node updates,
which are appended via the `add_messages` reducer, and which are overwritten:

<p align="center">
  <img src="article_agent_state_flow.png" alt="article agent state flow" width="900"/>
</p>

Open `article_agent.drawio` in [draw.io](https://app.diagrams.net) or the VS Code Draw.io
extension to edit.

## The thumbnail reflexion agent (assignment)

Same loop pattern, multi-file, with DALL-E image generation and a vision critic:

<p align="center">
  <img src="reflexion/graph.png" alt="thumbnail agent graph" width="240"/>
</p>
